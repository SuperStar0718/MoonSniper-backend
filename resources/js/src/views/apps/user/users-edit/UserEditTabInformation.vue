            ...
            <b-row class="mt-1">
                ...
                <b-col cols="12" md="6" lg="4">
                    <b-form-group label="Address Line 2" label-for="address-line-2">
                        <b-form-input id="address-line-2" v-model="userData.addressLine2" placeholder="Los Santos" />
                    </b-form-group>
                </b-col>
                ...
                <b-col cols="12" md="6" lg="4">
                    <b-form-group label="Postcode" label-for="postcode">
                        <b-form-input id="postcode" v-model="userData.postcode" type="number" placeholder="597626" />
                    </b-form-group>
                </b-col>
            ...
            <b-row class="mt-2">
                <b-col>
                    <b-button variant="primary" class="mb-1 mb-sm-0 mr-0 mr-sm-1" type="button"
                        :block="$store.getters['app/currentBreakPoint'] === 'xs'" @click="updateInformation">
                        Save Changes
                    </b-button>
