    ...
    <div class="position-fixed nav-background" style="height:100%;z-index:3;">
      ...
      skin === 'light'|| skin === 'bordered' ? 'menu-light' : 'menu-dark'
            ...
            <div class="navbar-header expanded">
                <slot name="header" :toggleVerticalMenuActive="toggleVerticalMenuActive"
                    :toggleCollapsed="toggleCollapsed" :collapseTogglerIcon="collapseTogglerIcon">
                ...
                {{ appName }}
                        ...
                        <li class="nav-item mr-auto lg-d-none-max">
                            <b-link class="nav-link modern-nav-toggle  ">
                                <feather-icon icon="XIcon" size="25" class="d-block d-xl-none toggle-icon"
                                    @click="toggleVerticalMenuActive" />
                                <feather-icon :icon="collapseTogglerIconFeather" size="25"
            ...
            <!-- Shadow -->
            <div :class="{'d-block': shallShadowBottom}" class="" />

            <div class="row mt-1 mb-4 user_info">
                <div class="d-none user-nav d-inline float-left w-50 text-center m-auto">
                    <p
                        style="margin-bottom:5px;font-family: Poppins;font-style: normal;font-weight: 700;font-size: 24px;letter-spacing: 3pt;">
                        {{ userData.fullName || userData.username }}
                    </p>
                    <p style="font-family: Poppins;margin: 7px;font-style: normal;font-weight: 500;font-size: 17px;">
                        {{ userData.role }}</p>
                ...
                <div class="float-right w-50 text-right pr-4">
                    <b-avatar size="100" :src="userData.avatar" :to="{ name: 'pages-profile'}" variant="light-primary"
            ...
            <!-- main menu content-->
            <vue-perfect-scrollbar :settings="perfectScrollbarSettings" class="main-menu-content scroll-area"
                tagname="ul" @ps-scroll-y="evt => { shallShadowBottom = evt.srcElement.scrollTop > 0 }">
        ...
        <div class="fulfill-navbar"
            style="border:none;margin-top: 962px;background-color: rgba(255, 255, 255, 0.07);height: calc(100vh - 962.5px);margin-right: 58px;">
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const collapseTogglerIconFeather = computed(() => (collapseTogglerIcon.value === 'unpinned' ? 'MenuIcon' :
                'XIcon'))
