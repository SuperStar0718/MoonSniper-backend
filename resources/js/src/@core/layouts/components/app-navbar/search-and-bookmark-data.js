...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Sweet Alert', route: { name: 'extensions-sweet-alert' }, icon: 'CheckCircleIcon', isBookmarked: false },
      ...
      { title: 'Toastification', route: { name: 'extensions-toastification' }, icon: 'CheckCircleIcon', isBookmarked: false },
      { title: 'Toasts', route: { name: 'components-toasts' }, icon: 'CheckCircleIcon', isBookmarked: false },
      ...
      { title: 'Unlocking', route: { name: 'unlocking-coins' }, icon: 'FileIcon', isBookmarked: false },
    ],
  },
  files: {
    key: 'file_name',
